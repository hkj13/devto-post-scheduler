// Quick test script to verify dashboard configuration works
require('dotenv').config()

// Set env vars from your dashboard config
...
process.env.POST_ON_STARTUP = 'true' // Test immediately

const multiPlatformPoster = require('./src/services/multiPlatformPoster')
