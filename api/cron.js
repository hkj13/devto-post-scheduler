...
async function generateContent(topic, config) {
    ...
    const prompt = `Create content about "${topic}" for two platforms in a SINGLE response.

1. DEV.TO ARTICLE:
- Title: Catchy, under 60 characters
- Content: 800-1200 words, markdown, code examples if relevant
- Tags: 4 relevant tags

2. TWITTER THREAD (5-6 tweets from the same content):
- Tweet 1: Hook with emoji, mention "thread 🧵"
- Tweets 2-5: Key insights from the article (max 270 chars each)
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Generate content (article + thread in single API call)
